...
if [ "${image_count}" -gt 0 ]; then
    read -p "Type the source image name [source:tag] : " -r source_name
    read -p "Type the namespace or just enter: " -r namespace
    read -p "Type the target image name [target:tag] : " -r target_name
